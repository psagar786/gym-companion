...
Start the local preview server and run the six-viewport browser smoke test. If port binding remains blocked by the environment, record the blocker and continue with static checks only.
